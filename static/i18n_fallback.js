const I18N_TEXT_KEYS = new Map([
  ...
  ["Browse, open, and manage projects. New projects are created in a modal dialog.", "history.projectsHelp"],
  ["Project creation now opens as a modal; this area keeps project browsing, opening, and deletion.", "history.projectHistoryHelp"],
  ["Create a training project. It will be opened automatically after creation.", "history.createProjectHelp"],
  ...
  ["Backend Connected", "labelme.backendConnected"],
  ["Import Label Files", "labelme.importTitle"],
  ["Import with mapping", "labelme.csvImportConfirm"],
  ["Images folder is opened by LabelMe. JSON folder stores annotation output.", "labelme.workspaceTooltip"],
  ["Output", "labelme.outputPath"],
  ["Classes", "labelme.classes"],
  ["Command", "labelme.command"],
  ["Open LabelMe", "labelme.openLabelMe"],
  ["Refresh Status", "labelme.refreshStatus"],
  ["Annotation Import Report", "labelme.importReportTitle"],
  ["Apply valid drafts", "labelme.applyImportDraft"],
  ["Status", "labelme.table.status"],
  ["Preview", "labelme.preview"],
  ["Export Formats", "labelme.exportFormats"],
  ["Open after JSON checks pass", "labelme.exportHelp"],
  ["Semantic Mask", "labelme.semanticMask"],
  ["Copy", "common.copy"],
  ["Missing JSON", "labelme.metric.missingJson"],
  ...
  ["Loading inference jobs...", "history.loadingInferenceJobs"],
  ["No inference jobs for the active project.", "history.noInferenceJobs"],
  ["Failed to load inference history:", "history.loadInferenceFailed"],
  ["Loading inference result...", "history.loadingInferenceResult"],
  ...
  ["View Result", "history.viewResult"],
  ...
  ["Hard Case", "autoLabel.hardCase"],
  ["Checkpoint", "autoLabel.model.checkpoint"],

  ["No comparison", "compare.noComparison"],
  ["Recommendation", "compare.recommendation"],
  ["Compare Selected", "compare.compareSelected"],
  ["Compare Outputs", "compare.compareOutputs"],
  ["Export Report", "compare.exportReport"],
  ["Remove", "common.remove"],
  ["Baseline", "compare.baseline"],
  ["Set Baseline", "compare.setBaseline"],
  ["Best overall", "compare.bestOverall"],
  ["Metric", "compare.metric"],
  ["Best Run", "compare.bestRun"],
  ["Value", "compare.value"],
  ["Latest Export", "compare.latestExport"],
  ["Report History", "compare.reportHistory"],
  ["Exporting", "common.exporting"],
  ["Not exported", "compare.notExported"],
  ["Exporting compare report...", "compare.exportingReport"],
  ["No compare reports have been exported for this project.", "compare.noReports"],
  ["Open a project to compare training runs.", "compare.openProject"],
  ["Loading comparable runs...", "compare.loadingRuns"],
  ["Select completed runs from the list. The first selected run becomes baseline.", "compare.selectRuns"],
  ["Run comparison to see best model by metric, tradeoffs, and warnings.", "compare.runComparisonHelp"],
  ["Config differences appear after comparison.", "compare.configDiffEmpty"],
  ["Selected runs have no visible config differences in tracked fields.", "compare.noConfigDiff"],
...
const ZH_TEXT = new Map([
  ...
  ["Project Readiness", "專案就緒狀態"],
  ["Tabular Project Readiness", "Tabular 專案就緒狀態"],
  ["Projects Status", "專案狀態"],
  ["History Status", "歷史紀錄狀態"],
  ["Settings Status", "設定狀態"],
  ["Page Context", "頁面資訊"],
