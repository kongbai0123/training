...
[![Version](https://img.shields.io/badge/version-0.1.10-2563EB)](VERSION)
[![Release](https://img.shields.io/badge/release-v0.1.10%20Update-16A34A)](https://github.com/kongbai0123/training/releases/tag/v0.1.10)
...
[取得最新更新](https://github.com/kongbai0123/training/releases/tag/v0.1.10) ·
...
- [下載 v0.1.10 增量更新包與 SHA-256 checksum](https://github.com/kongbai0123/training/releases/tag/v0.1.10)
- [完整版本變更紀錄](CHANGELOG.md)

新安裝或尚未具備目前更新執行環境的使用者，請先安裝 v0.1.6 完整安裝程式。v0.1.10 為 `runtime-r1` 增量更新，只接受 v0.1.9；較舊版本須依序套用相容更新，不能直接跳版。設定頁會檢查版本與 runtime，相容時才提供下載與套用，不相容時會引導使用完整安裝程式。
...
1. [v0.1.10 增量更新驗證紀錄](docs/RELEASE_VALIDATION_2026-07-24_0.1.10.md)
2. [v0.1.4 更新系統與安裝驗證紀錄](docs/RELEASE_VALIDATION_2026-07-23_0.1.4.md)
3. [v0.1.3 發布驗證紀錄](docs/RELEASE_VALIDATION_2026-07-22_0.1.3.md)
4. [v0.1.2 發布驗證紀錄](docs/RELEASE_VALIDATION_2026-07-22.md)
5. [v0.1.1 發布驗證紀錄](docs/RELEASE_VALIDATION_2026-07-16.md)
