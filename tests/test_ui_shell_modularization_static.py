...
class UIShellModularizationStaticTests(unittest.TestCase):
    ...
    def test_style_shell_delegates_design_tokens_to_styles_module(self):
        ...
        self.assertTrue(
            style_css.startswith(
                ...
                '@import "./styles/pages/model_guide.css?v=20260724-model-guide-controls2";\n'
        ...
        self.assertNotRegex(training_css, r"(?m)^\.training-mode-toggle \{")
    ...
    def test_app_shell_delegates_common_shell_rendering_to_core_modules(self):
        ...
        self.assertIn('import { bootstrapApp } from "./core/bootstrap.js?v=20260902-unified-evaluation";', app_js)
        ...
        self.assertIn('from "./page_registry.js?v=20260902-unified-evaluation"', bootstrap_js)
        ...
        self.assertIn('openProject(projectId, { page: "training", moduleOverview: true })', bootstrap_js)
        self.assertIn('openProject(appState.currentProjectId, { stayOnPage: true })', bootstrap_js)
