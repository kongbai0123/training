...
class UIShellModularizationStaticTests(unittest.TestCase):
    ...
    def test_app_shell_delegates_common_shell_rendering_to_core_modules(self):
        ...
        self.assertIn('import { bootstrapApp } from "./core/bootstrap.js?v=20260713-model-guide-evidence";', app_js)
        ...
        self.assertIn('from "./page_registry.js?v=20260713-model-guide-evidence"', bootstrap_js)
