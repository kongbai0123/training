...
class UIShellModularizationStaticTests(unittest.TestCase):
    ...
    def test_state_shell_delegates_i18n_dictionary_and_fallback_to_state_module(self):
        ...
        self.assertIn("safeCatalogValue(dict, key, i18n.en?.[key])", i18n_js)
        ...
        self.assertIn('"rnn.training.setupTitle": "訓練設定"', zh_tw_js)
    ...
    def test_app_shell_delegates_common_shell_rendering_to_core_modules(self):
        ...
        self.assertIn('import { bootstrapApp } from "./core/bootstrap.js?v=20260708-rnn-active-run";', app_js)
        ...
        self.assertIn('from "./page_registry.js?v=20260708-rnn-active-run"', bootstrap_js)
