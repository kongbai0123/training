...
EXPECTED_ROUTE_PATHS = {
    ...
    "/api/project-assistant/projects/{project_id}/sync-artifacts",
    "/api/project-assistant/retrieval/query",
    "/api/project-assistant/chat",
    "/api/project-assistant/chat/stream",
    "/api/project-assistant/sandbox",
    "/api/project-assistant/evaluation/report",
    "/api/project-assistant/evaluation/golden-set",
    "/api/rag-workbench/status",
    "/api/rag-workbench/knowledge-base",
    "/api/rag-workbench/knowledge-base/upload",
    "/api/rag-workbench/projects/{project_id}/sync-artifacts",
