...
class RNNTrainingPageStaticTests(unittest.TestCase):
    def test_rnn_training_controls_expose_p1_hardening_fields(self):
        ...
        self.assertIn("buildRnnTrainingRightPanel", app_js)
        self.assertIn("RNN Context", app_js)
        self.assertIn("isRnnTrainingWorkspaceActive(pageId)", app_js)
        self.assertIn("section.style.display = \"none\";", app_js)
