...
class ProjectAssistantPageStaticTests(unittest.TestCase):
    def test_project_assistant_is_not_primary_sidebar_navigation(self):
        ...
        self.assertIn('id="rag-chat-empty-kb"', html)
        self.assertIn('id="rag-chat-status"', html)
        self.assertIn('<textarea id="rag-chat-input"', html)
    ...
    def test_project_assistant_module_is_registered_and_calls_contract_apis(self):
        ...
        self.assertIn('event.key !== "Enter" || event.shiftKey', module)
        self.assertIn('t("assistant.searchingHelp")', module)
        self.assertIn('t("assistant.emptyKbTitle")', module)
        self.assertIn('eventBus.on("project-opened"', module)
        self.assertIn("handleAssistantProjectOpened", module)
        self.assertIn("locale: appState.settings?.language", module)
    ...
    def test_project_assistant_i18n_and_legacy_css_are_wired(self):
        ...
        self.assertIn(".assistant-empty-kb", css)
        self.assertIn(".assistant-chat-status.is-searching", css)
