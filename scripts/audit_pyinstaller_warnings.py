...
EXPECTED_PATTERNS = [
    ...
    r"missing module named ['\"]?jax\.(typing|_src|random|lax)\b",
    r"missing module named ['\"]?flax\.(traverse_util|core|linen|serialization)\b",
    r"missing module named ['\"]?nltk\.corpus\.(?:reader\.)?(?:CorpusReader|WordNetCorpusReader)\b",
    r"missing module named ['\"]?hf_xet\.Py(?:TotalProgressUpdate|ItemProgressUpdate)\b",
    r"missing module named ['\"]?transformers\.(?:UdopConfig|RegNetConfig|AutoModelForImageTextToText)\b",
    r"missing module named ['\"]?tensorflow\.compiler\b",
    r"missing module named ['\"]?selective_scan_cuda\b",
    r"missing module named ['\"]?msgpack\b.*transformers\.modeling_flax",
    ...
    r"missing module named ['\"]?typer\b.*huggingface_hub\.inference\._mcp",
